...
let data = [
    ...
    },
    {
        ...
        contents: [
            ...
            {
                list: '노인 우울증',
                detail: '65세 이후에 처음 나타나는 우울 증상으로, 주로 여성이 더 빈번하게 나타납니다. 부적절한 슬픔과 강한 분노, 의기소침 등의 정서적 변화, 수면장애, 소화불량, 두통, 무기력, 식욕부진 등의 신체적인 변화 및 건강염려증의 증상, 자해 및 음주, 대인관계 기피 같은 행동들이 나타납니다. 치료의 초점은 실제적인 대인관계 상실, 건강 상실, 경제능력 상실 등과 관련된 자존감 저하이며, 사회적인 지지망 강화를 통한 자존감 향상이 중요하게 작용할 것입니다.'
            },
            {
                list: '노인치매',
                detail: '알츠하이머병은 서서히 발병하여 점진적으로 진행이 되며 초기에는 기억력에 대한 문제가 보이지만 점차 언어기능, 판단력 등의 인지 기능의 이상을 보이고 결국에는 일상생활 기능을 상실하게 됩니다. 치매는 초기에 발견하는 것이 최선책이며 센터에서 치매 관련 평가 및 검사를 받을 수 있습니다.'
            },
        ]
    },
    {
