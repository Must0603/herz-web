        ...
        contents: [
            ...
            },
            {
                ...
                detail: `
                    ...
                    청소년: MMPI-A(미네소타다면적성격검사), SCT(문장완성검사), JTCI(기질성격검사) (15세 이상 실시 가능)<br>
                    성인: MMPI-2(미네소타 다면적 성격검사), SCT(문장완성검사), TCI(기질성격검사)
                `
            },
        ]
    },
        ...
        contents: [
            ...
            },
            {
                ...
                detail: `
                    CAT(주의력검사)<br>
                    ADS(시각, 청각) <br>
                    Stroop test(스트룹 아동 색상-단어 검사)<br>
                    CCTT(아동 색 선로 검사)<br> 
                    MFFT(아동충동성 검사)
                `
            }
